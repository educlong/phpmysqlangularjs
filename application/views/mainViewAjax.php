    ...
    <div class="container">
        <div class="row" style="margin-top: 50px;">
            ...
            <!-- <form   method="post" enctype="multipart/form-data" 
                    action="< ?= base_url() ?>index.php/mainAjax/insertEmployee"> -->
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <small class="btn btn-outline-warning btn-xs">
                                            <a href="<?= base_url() ?>index.php/mainAjax/updateEmployeeOpening/<?= $value['idEmp'] ?>" class="card-link linkfbEmp"> Update <i class="fal fa-pencil"></i><i class="fa fa-chevron-right"></i></a>
                                        </small> <!-- các thông số quan trọng đc sử dụng: href truyền đến controller-->
                                    </div>
                                    <div class="col-sm-6">
                                        <small class="btn btn-outline-danger btn-xs">
                                            <a href="<?= base_url() ?>index.php/mainAjax/deleteEmployee/<?= $value['idEmp'] ?>" class="card-link linkfbEmp"> Delete <i class="fas fa-trash"></i><i class="fa fa-chevron-right"></i></a>
                                        </small> <!-- các thông số quan trọng đc sử dụng: href truyền đến controller-->
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#inputAvatarEmp').fileupload({   /*fileupload là hàm đc định nghĩa sẵn trong thư viện ngoài jqueryuploadfile*/
                url: '<?php echo base_url() ?>index.php/mainAjax/uploadImageAvatarAjax',   /*url đến controller*/
                dataType: 'json',
                type: 'POST',
                autoUpload: true,
                add: function (e, data) {
                    ...
                    $.each(data.result.files, function (index, file) {
                        console.log(pathUploadAvatar);
                                    ...
                                    /*| url là mainAjax/insertEmployeeProcessingInAjax (xong trong controller)*/
                                    /*|*/
                                    /*V*/
            $(".btnInsertEmp").click(function(event) {/*hàm này sẽ đc thực hiện thi click vào button class btnInsertEmp*/
                ...
                $.ajax({
                    url: 'insertEmployeeProcessingInAjax',   /*đường dẫn đễn action*/
                    type: 'POST',       /*kiểu POST*/
