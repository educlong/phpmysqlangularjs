...
<head>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>angularJsDemo1/angularjsDemo1.js"></script>
</head>
<body ng-app='angularDemo1' class="ng-cloak"  ng-controller="AngularJsControllerDemo1 as controllerDemo1">
    <!-- ĐỊNH NGHĨA ng-app ĐỂ PHỤC VỤ CHO ANGULAR JS , controllerDemo đặt bí danh cho AngularJsControllerDemo1-->
    ...
    <div class="container-fluid">
        <div class="row" ng-repeat="aDataAngDemo1 in datasAngDemo1" ng-init="aDataAngDemo1.displayDataAngDemo1=true">
            <div class="card col-sm-10 push-sm-1 text-center" >
                <div class="card-header" ng-hide="aDataAngDemo1.displayDataAngDemo1">   <!-- Phần chỉnh sửa -->
                    <div class="row">
                        <h5 class="card-title col-sm-3" style="padding: 8px 0 0 0"><b>Page: </b></h5>
                        <input type="text" class="form-control form-control-sm col-sm-7" ng-model="aDataAngDemo1.page">
                        <button class="float-xs-right col-sm-1 btn btn-outline-success" style="border: white;" ng-click="saveDatabaseAngDemo1(aDataAngDemo1)"><i class="fas fa-check"></i></button>
                        <button class="float-xs-right col-sm-1 btn btn-outline-secondary" style="border: white;" ng-click="changeDisplayAngDemo1(aDataAngDemo1)"><i class="fas fa-times"></i></button>
                    </div>
                </div>
                <div class="card-header" ng-show="aDataAngDemo1.displayDataAngDemo1">   <!-- Phần hiển thị -->
                    <div class="container">
                        <div class="row">
                            <div class="">
                                <div class="row">
                                    <h5 class="card-title col-sm-10 push-sm-1"><b>Page: </b><i>{{aDataAngDemo1.page}}</i> </h5>
                                    <button class="float-xs-right col-sm-1 push-sm-1 btn btn-outline-warning" style="border: white;" ng-click="changeDisplayAngDemo1(aDataAngDemo1)"><i class="fas fa-pencil-alt"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <div class="container">
                        ...
                        <div class="row" ng-hide="aDataAngDemo1.displayDataAngDemo1">   <!-- Phần chỉnh sửa -->
                            <h6 class="col-sm-3"><b>Title: </b></h6>
                            <input type="text" class="form-control form-control-sm col-sm-7" ng-model="aDataAngDemo1.title">
                            <button class="float-xs-right col-sm-1 btn btn-outline-success" style="border: white;" ng-click="saveDatabaseAngDemo1(aDataAngDemo1)"><i class="fas fa-check"></i></button>
                            <button class="float-xs-right col-sm-1 btn btn-outline-secondary" style="border: white;" ng-click="changeDisplayAngDemo1(aDataAngDemo1)"><i class="fas fa-times"></i></button>
                        </div>
                        <div class="row"  ng-show="aDataAngDemo1.displayDataAngDemo1">   <!-- Phần hiển thị -->
                            <div class="">
                                <div class="row">
                        ...
                        <div class="row" ng-hide="aDataAngDemo1.displayDataAngDemo1">   <!-- Phần chỉnh sửa -->
                            <h6 class="col-sm-3"><b>Subtitle: </b></h6>
                        ...
                        <div class="row"  ng-show="aDataAngDemo1.displayDataAngDemo1">   <!-- Phần hiển thị -->
                            <div class="">
                                ...
                                <div class="row">
                                    <div class="text-left">{{aDataAngDemo1.content}}</div>
                                </div>
                            </div>
                        </div>
                        <div class="row" ng-hide="aDataAngDemo1.displayDataAngDemo1">   <!-- Phần chỉnh sửa -->
                            <h6 class="col-sm-3"><b>Image: </b></h6>
                        ...
                        <div class="row" ng-hide="aDataAngDemo1.displayDataAngDemo1">   <!-- Phần chỉnh sửa -->
                            <h6 class="col-sm-3"><b>Author: </b></h6>
