    ...
    <div class="container">
        <div class="row" style="margin-top: 50px;">                           
            <form   method="post" enctype="multipart/form-data" 
                    action="<?= base_url() ?>EmployeeMainAjax/updateEmployee">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4" style=" display: flex; align-items: center; justify-content: center;">
                                ...
                                <button type="reset" class="btn btn-outline-danger btn-xs">
                                    <a href="<?= base_url() ?>EmployeeMainAjax/deleteEmployeeModel/<?= $value['idEmp'] ?>" class="card-link linkfbEmp"> Back <i class="fas fa-trash"></i><i class="fa fa-chevron-right"></i></a>
                                </button>
                            </div>
                        </div>
